    ...
    <div class="row">
        ...
        <div class="col-md-5 card mt-md-3">
            ...
            <div class="row text-center">
                <div class="col-md-3">
                    <a onclick="setReaccion(<?= $_GET["product_id"] ?>, 'like')"
                       class="btn">
                ...
                <div class="col-md-3">
                    <a onclick="setReaccion(<?= $_GET["product_id"] ?>,'dislike')" type="submit" class="btn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="currentColor"
...
<script type="text/javascript">
    function setReaccion(productId, likeOrDislike) {
        $.ajax(
            {
