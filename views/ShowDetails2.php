...
$productClase = $product['clase'];
$productImage = $product['image'];
$productAmount = $product ['cantidad'];
$productPrecio = number_format($product['precio'], 2, ',', '.');
?>
<!doctype html>
<html lang="en">
<head>
...
<div class="row">
    <div class="col-md-6 m-md-2">
        ...
        <p style="font-weight: normal; color: #bdbdbd">Familia: <?=$productClase?> </p>
        <div class="text-center"><img src="../images/products/<?=$productImage?>" width="500" alt="..."></div>
    </div>
    <div class="col-md-5 card mt-md-3">
        <h1 style="font-size: 50px;font-weight: normal" class="text-danger m-md-2">$ <?= $productPrecio?> </h1>
        <h5 style="color: #bdbdbd">Unidad a $ <?=$productPrecio?> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tags" viewBox="0 0 16 16">
                <path d="M3 2v4.586l7 7L14.586 9l-7-7H3zM2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586V2z"/>
                <path d="M5.5 5a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1zm0 1a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM1 7.086a1 1 0 0 0 .293.707L8.75 15.25l-.043.043a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 0 7.586V3a1 1 0 0 1 1-1v5.086z"/>
            </svg></h5>
        <?php if($productAmount > 0) :?>
        <a href="../controllers/compra.php?product_id=<?=$product['id']?>" style="font-size: 40px; border-radius: 20px"  type="buttom" class="btn btn-danger mt-md-5">Comprar ahora</a>
            <a href="../controllers/addToCarrito.php?product_id=<?=$product['id']?>" style="font-size: 30px; border-radius: 30px" type="buttom" class=" mt-md-4 btn btn-outline-danger">Añadir al carrito <svg xmlns="http://www.w3.org/2000/svg" width="26" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
