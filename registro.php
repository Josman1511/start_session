...
<form action="addRegisterToBaseDatos.php" method="post">
    <input placeholder="Ingrese su nombre" class="input" style="position: absolute; top: 250px; left: 450px;" type="text" name="usernameRegister" required>
    <input placeholder="Ingrese su contraseña" class="input" style="position: absolute; top: 350px; left: 450px;" type="password" name="passwordRegister" required>
